...
export default function UnderMain() {
  ...
  return (
    <section className="py-20 bg-linear-to-b from-white to-gray-50">
      ...
      <div className="flex flex-col md:flex-row-reverse gap-10 max-w-6xl mx-auto px-6">
        {steps.map((s, i) => (
          <div
            key={i}
            className="bg-white rounded-2xl shadow-md p-8 text-center hover:shadow-xl transition flex-1"
          >
